...
const ctrlSearch = async (city) => {
  ...
  if (navigator.onLine) {
    ...
    if (document.querySelector('.container').contains(document.querySelector('.photos')) ){
      searchView.clean();
      sliderView.clean();
      searchView.rmvStatus();
    }
    
    if (document.querySelector('.container').contains(document.querySelector('.history'))){
    ...
    try {
      ...
      renderLoader(document.querySelector('.info'));
    ...
    searchView.delSearch();
    historyView.initializeHistory();    
    historyView.render();
...
const ctrlPlaces = async () => {
  ...
  try{
    ...
    renderLoader(document.querySelector('.events__main'));
